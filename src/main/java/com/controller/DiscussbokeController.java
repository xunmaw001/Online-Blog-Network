...
public class DiscussbokeController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscussbokeEntity discussboke, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussbokeEntity discussboke, HttpServletRequest request){
        EntityWrapper<DiscussbokeEntity> ew = new EntityWrapper<DiscussbokeEntity>();
		PageUtils page = discussbokeService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discussboke), params), params));
        return R.ok().put("data", page);
    }
