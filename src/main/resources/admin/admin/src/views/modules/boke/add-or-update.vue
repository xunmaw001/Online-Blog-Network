<template>
  <div>
    ...
    >
      <el-row>
                  <el-col :span="12">
        <el-form-item  v-if="type!='info'"  label="博客名称" prop="bokemingcheng">
          <el-input v-model="ruleForm.bokemingcheng" 
              placeholder="博客名称" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.bokemingcheng" label="博客名称" prop="bokemingcheng">
              <el-input v-model="ruleForm.bokemingcheng" 
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
                    if(o=='bokemingcheng'){
            this.ruleForm.bokemingcheng = obj[o];
            continue;
          }
                    if(o=='fenlei'){
